...
const DestinationCard: React.FC<DestinationCardProps> = ({ destination, className = '' }) => {
  ...
  return (
    <div className={`relative group overflow-hidden rounded-lg   transition-all duration-300 ${className}`}>
      {/* Image */}
      <div className="relative h-[460px] w-full max-w-[407px] rounded-[50px] overflow-hidden">
        <Image
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-16 text-white">
          <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
            ...
            <h3 className="text-5xl font-bold mb-2">{destination.name}</h3>
