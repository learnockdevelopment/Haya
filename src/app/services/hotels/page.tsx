...
import HotelsSection from "@/components/ui/HotelSection";
import HotelSearch from "@/components/ui/HotelSearch";
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-white min-h-[70vh] flex items-center">
        <div className="grid grid-cols-2 justify-between w-full py-20 pt-0 gap-8 md:gap-20 items-center pl-24 ">
          <div className="col-span-2 lg:col-span-1 flex justify-end">
            <div className="max-w-2xl text-center lg:text-left px-20 ">
            ...
            <h1 className="text-text-900  xl:text-6xl lg:text-4xl text-2xl my-6 font-semibold">
              {t("service.subtitle_hero_hotel")}
            </h1>
            <p className="text-text-500 lg:text-lg text-sm">
              {t("service.main_title_hero_hotel")}
            </p>
            </div>
          </div>
          <div className="col-span-2 lg:col-span-1 flex justify-end">
            <img src="/images/hotelsHero.png" alt=""  className="max-h-[900px]"/>
          </div>
        </div>
      </section>

      {/* hotels and filter section  Section */}
      <HotelSearch />
